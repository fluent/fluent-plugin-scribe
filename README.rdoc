...
This is a plugin for fluentd[http://fluentd.org] event collector. This plugin adds the Scribe[https://github.com/facebook/scribe] compatible interface to fluentd.
